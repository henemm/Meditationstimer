...
Streak tracking system that counts consecutive days of activity for meditation, workouts, and NoAlc. Includes a reward system for NoAlc that provides "forgiveness" credits for occasional moderate days.
...
#### Scenario: Calendar Header Display
...
- **Threshold:** `minMinutes = 2` is configurable constant in StreakManager
