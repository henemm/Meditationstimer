...
private let defaultWorkoutSets: [WorkoutSet] = [
    ...
    WorkoutSet(
        ...
        emoji: "💪",
        phases: [
            WorkoutPhase(name: "Plank", workDuration: 45, restDuration: 15),
            WorkoutPhase(name: "Side Plank Left", workDuration: 30, restDuration: 15),
            WorkoutPhase(name: "Side Plank Right", workDuration: 30, restDuration: 15),
            WorkoutPhase(name: "Bicycle Crunches", workDuration: 40, restDuration: 15),
            WorkoutPhase(name: "Leg Raises", workDuration: 30, restDuration: 15),
    ...
    WorkoutSet(
        ...
        phases: [
            ...
            WorkoutPhase(name: "Squats", workDuration: 40, restDuration: 20),
            WorkoutPhase(name: "Push-ups", workDuration: 30, restDuration: 20),
            WorkoutPhase(name: "Mountain Climbers", workDuration: 30, restDuration: 20),
            WorkoutPhase(name: "Lunges", workDuration: 40, restDuration: 20),
    ...
    WorkoutSet(
        ...
        emoji: "⚡",
        phases: [
            WorkoutPhase(name: "Jump Squats", workDuration: 40, restDuration: 20),
    ...
    WorkoutSet(
        ...
        phases: [
            ...
            WorkoutPhase(name: "Single-Leg Deadlift Left", workDuration: 20, restDuration: 10),
            WorkoutPhase(name: "Single-Leg Deadlift Right", workDuration: 20, restDuration: 15),
            WorkoutPhase(name: "Bulgarian Split Squats Left", workDuration: 20, restDuration: 10),
            WorkoutPhase(name: "Bulgarian Split Squats Right", workDuration: 20, restDuration: 15),
            WorkoutPhase(name: "Reverse Lunges", workDuration: 40, restDuration: 15),
    ...
    WorkoutSet(
        ...
        phases: [
            ...
            WorkoutPhase(name: "Leg Swing Left", workDuration: 30, restDuration: 10),
            WorkoutPhase(name: "Walking Lunges", workDuration: 40, restDuration: 10),
    ...
    WorkoutSet(
        ...
        emoji: "🧘‍♂️",
        phases: [
            WorkoutPhase(name: "Quadriceps Stretch Left", workDuration: 22, restDuration: 5),
            WorkoutPhase(name: "Quadriceps Stretch Right", workDuration: 22, restDuration: 10),
            WorkoutPhase(name: "Hamstring Stretch Left", workDuration: 22, restDuration: 5),
            WorkoutPhase(name: "Hamstring Stretch Right", workDuration: 22, restDuration: 10),
            WorkoutPhase(name: "Hip Flexor Stretch Left", workDuration: 22, restDuration: 5),
            WorkoutPhase(name: "Hip Flexor Stretch Right", workDuration: 22, restDuration: 10),
            WorkoutPhase(name: "Calf Stretch Left", workDuration: 22, restDuration: 5),
            WorkoutPhase(name: "Calf Stretch Right", workDuration: 22, restDuration: 10),
            WorkoutPhase(name: "Butterfly Stretch", workDuration: 60, restDuration: 10),
    ...
    WorkoutSet(
        ...
        emoji: "🌱",
        phases: [
            WorkoutPhase(name: "Marching in Place", workDuration: 40, restDuration: 20),
            WorkoutPhase(name: "Wall Push-ups", workDuration: 30, restDuration: 20),
            WorkoutPhase(name: "Squats", workDuration: 30, restDuration: 20),
            WorkoutPhase(name: "Plank (Knees)", workDuration: 30, restDuration: 20),
    ...
    WorkoutSet(
        ...
        phases: [
            ...
            WorkoutPhase(name: "Jumping Jacks", workDuration: 30, restDuration: 15),
    ...
    WorkoutSet(
        ...
        emoji: "💪",
        phases: [
            WorkoutPhase(name: "Push-ups", workDuration: 40, restDuration: 20),
            WorkoutPhase(name: "Diamond Push-ups", workDuration: 30, restDuration: 20),
            WorkoutPhase(name: "Wide Push-ups", workDuration: 30, restDuration: 20),
            WorkoutPhase(name: "Pike Push-ups", workDuration: 30, restDuration: 20),
