...
1. **Primary Features:** Meditation, Breathing, Workouts
   - Prominent UI, explicit interaction

2. **Support Features:** Streaks, Calendar, Statistics
   - Visible but secondary

3. **Passive Features:** Smart Notifications, background tracking
