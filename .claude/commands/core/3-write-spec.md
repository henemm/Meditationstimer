...
Task (general-purpose/sonnet): "Du bist der spec-writer Agent.
  Lies die Instruktionen aus .agent-os/agents/core/spec-writer.md.
  ...
  nach dem spec-writer Workflow.

  iOS-spezifisch:
  - Test Plan muss XCTest Unit Tests UND XCUITests enthalten
  - Acceptance Criteria muessen automatisiert testbar sein
  - HealthKit-Integration beachten wo relevant
  - Scoping: Max 4-5 Dateien, +/-250 LoC"
```
...
Task (general-purpose/haiku): "Du bist der spec-validator Agent.
  Lies die Instruktionen aus .agent-os/agents/core/spec-validator.md.
...
>
> Scope: [N] files, ~[N] LoC
> Test plan: [N] Unit Tests, [N] XCUITests
> Validation: VALID
>
